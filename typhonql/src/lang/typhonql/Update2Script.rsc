...
void compileRefSet(
  ...
  SQLStat theUpdate = update(tableName(to), [\set(fk, ctx.sqlMe)],
    [where([equ(column(tableName(to), typhonId(to)), lit(Value::uuid(uuid2str(ref))))])]);
...
void compileRefSet(
  ...
  ctx.addSteps(updateIntoJunctionSingle(dbName, from, fromRole, to, toRole, ctx.sqlMe, lit(Value::uuid(uuid2str(ref))), ctx.myParams));
  ctx.addSteps(updateIntoJunctionSingle(other, to, toRole, from, fromRole, lit(Value::uuid(uuid2str(ref))), ctx.sqlMe, ctx.myParams));
}
...
void compileRefSet(
  ...
  ctx.addSteps(updateIntoJunctionSingle(dbName, from, fromRole, to, toRole, ctx.sqlMe, lit(Value::uuid(uuid2str(ref))), ctx.myParams));
  ctx.addSteps(updateObjectPointer(other, to, toRole, toCard, DBObject::uuid(uuid2str(ref)), ctx.mongoMe, ctx.myParams));
} 
...
void compileRefSet(
  ...
  ctx.updateSQLUpdate(SQLStat(SQLStat upd) {
    ...
    upd.sets += [\set(fk, lit(Value::uuid(uuid2str(ref))))];
    return upd;
  });
}
...
void compileRefSet(
  ...
  // it's single ownership, so dont' insert in the junction but update.
  ctx.addSteps(updateIntoJunctionSingle(dbName, from, fromRole, parent, parentRole, lit(Value::uuid(uuid2str(ref))), ctx.sqlMe, ctx.myParams));
  ctx.addSteps(updateIntoJunctionSingle(other, parent, parentRole, from, fromRole, lit(Value::uuid(uuid2str(ref))), ctx.sqlMe, ctx.myParams));
}
...
void compileRefSet(
  ...
  ctx.addSteps(updateIntoJunctionSingle(dbName, from, fromRole, parent, parentRole, lit(Value::uuid(uuid2str(ref))), ctx.sqlMe, ctx.myParams));
  ctx.addSteps(updateObjectPointer(other, parent, parentRole, parentCard, DBObject::uuid(uuid2str(ref)), ctx.mongoMe, ctx.myParams));
}
...
void compileRefSet(
  ...
  ctx.updateMongoUpdate(DBObject(DBObject upd) {
    upd.props += [ <"$set", DBObject::uuid(uuid2str(ref))> ];
    return upd;
  });
  ctx.addSteps(updateObjectPointer(dbName, to, toRole, toCard, DBObject::uuid(uuid2str(ref)), ctx.mongoMe, ctx.myParams));
}
...
void compileRefSetMany(
 ...
 // whose _id is not in refs.
  DBObject q = object([<"_id", object([<"$nin", array([ DBObject::uuid(uuid2str(ref)) | UUID ref <- refs ])>])>
     , <toRole, ctx.mongoMe>]);
...
void compileRefSetMany(
  ...
  ctx.updateMongoUpdate(DBObject(DBObject upd) {
    upd.props += [ <"$set", array([ DBObject::uuid(uuid2str(ref )) | UUID ref <- refs ])> ];
    return upd;
  });
  ctx.addSteps([ *updateObjectPointer(dbName, to, toRole, toCard, DBObject::uuid(uuid2str(ref)), ctx.mongoMe, ctx.myParams)
                | UUID ref <- refs ]);
  ...
  DBObject q = object([<"_id", object([<"$nin", array([ DBObject::uuid(uuid2str(ref)) | UUID ref <- refs ])>])>, <toRole, ctx.mongoMe>]);
...
void compileRefAddTo(
  ...
  ctx.addSteps(insertObjectPointers(dbName, from, fromRole, fromCard, ctx.mongoMe, 
             [ DBObject::uuid(uuid2str(ref)) | UUID ref <- refs ], ctx.myParams));
  ctx.addSteps([ *insertObjectPointer(dbName, to, toRole, toCard, DBObject::uuid(uuid2str(ref)) , ctx.mongoMe, ctx.myParams)
                | UUID ref <- refs ]);
}
...
void compileRefRemoveFrom(
  ...
  ctx.addSteps(deleteManyMongo(other, to, [ DBObject::uuid(uuid2str(ref)) | UUID ref <- refs ], ctx.myParams));
}
...
void compileRefRemoveFrom(
  ...
  ctx.addSteps(removeObjectPointers(dbName, from, fromRole, fromCard, ctx.mongoMe, 
             [ DBObject::uuid(uuid2str(ref)) | UUID ref <- refs ], ctx.myParams));  
  ctx.addSteps([*removeObjectPointers(dbName, to, toRole, toCard, DBObject::uuid(uuid2str(ref)), [ctx.mongoMe], ctx.myParams)
                | UUID ref <- refs ]);
}
...
void compileRefRemoveFrom(
  ...
  ctx.addSteps(removeObjectPointers(dbName, from, fromRole, fromCard, ctx.mongoMe, 
             [ DBObject::uuid(uuid2str(ref)) | UUID ref <- refs ], ctx.myParams));  
  ctx.addSteps([*removeObjectPointers(other, to, toRole, toCard, DBObject::uuid(uuid2str(ref)), [ctx.mongoMe], ctx.myParams)
                | UUID ref <- refs ]);
}
